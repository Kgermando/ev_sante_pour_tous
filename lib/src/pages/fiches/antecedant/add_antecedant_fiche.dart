...
class AddAntecedantFiche extends StatefulWidget {
  const AddAntecedantFiche({Key? key, this.identiteFicheModel})
      : super(key: key);
  final IdentiteFicheModel? identiteFicheModel;

  @override
  State<AddAntecedantFiche> createState() => _AddAntecedantFicheState();
}

class _AddAntecedantFicheState extends State<AddAntecedantFiche> {
                ...
                child: Scrollbar(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (widget.identiteFicheModel!.sexe != 'Homme')
      ...
      child: Column(
        ...
        children: [
          ...
          Responsive.isDesktop(context)
              ...
              : Column(
                  children: [ddrWidget(), pariteWidget()],
                ),
          Responsive.isDesktop(context)
              ? Row(
                  children: [
  ...
  Future<void> submit() async {
    final antecedantFicheModel = AntecedantFicheModel(
        ...
        ddr: (ddrController.text == "")
            ? DateTime.parse("0000-00-00 00:00:00.000")
            : DateTime.parse(ddrController.text),
